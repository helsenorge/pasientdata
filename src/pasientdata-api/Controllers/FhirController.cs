...
{
    // NOTE: This class can handle any Resource Type and is just here as an example.
    ...
    public class FhirController : ControllerBase
    {
        ...
        public ActionResult<FhirResponse> VRead(string type, string id, string vid)
        {
        ...
        //[HttpPost("{type}")]
        public ActionResult<FhirResponse> Create(string type, Resource resource)
        {
        ...
        //[HttpDelete("{type}/{id}")]
        public ActionResult<FhirResponse> Delete(string type, string id)
        {
            Key key = Key.Create(type, id);
            ActionResult<FhirResponse> response = _fhirService.Delete(key);
            return response;
        }

        //[HttpDelete("{type}")]
        public ActionResult<FhirResponse> ConditionalDelete(string type)
        {
        ...
        public ActionResult<FhirResponse> History(string type, string id)
        {
            Key key = Key.Create(type, id);
        ...
        public ActionResult<FhirResponse> Validate(string type, string id, Resource resource)
        {
            Key key = Key.Create(type, id);
        ...
        public ActionResult<FhirResponse> Validate(string type, Resource resource)
        {
            Key key = Key.Create(type);
            return _fhirService.ValidateOperation(key, resource);
        }
        ...
        //[HttpGet("{type}")]
        public ActionResult<FhirResponse> Search(string type)
        {
        ...
        public ActionResult<FhirResponse> SearchWithOperator(string type)
        {
        ...
        public ActionResult<FhirResponse> History(string type)
        {
            var parameters = new HistoryParameters(Request);
        ...
        //[HttpPost, Route("")]
        public ActionResult<FhirResponse> Transaction(Bundle bundle)
        {
            return _fhirService.Transaction(bundle);
        }

        //[HttpGet, Route("_history")]
        public ActionResult<FhirResponse> History()
        {
            var parameters = new HistoryParameters(Request);
        ...
        public ActionResult<FhirResponse> Snapshot()
        {
        ...
        public ActionResult<FhirResponse> ServerOperation(string operation)
        {
        ...
        public ActionResult<FhirResponse> InstanceOperation(string type, string id, string operation, Parameters parameters)
        {
            Key key = Key.Create(type, id);
            switch (operation.ToLower())
            {
        ...
        public ActionResult<FhirResponse> Everything(string type, string id = null)
        {
            Key key = Key.Create(type, id);
        ...
        public ActionResult<FhirResponse> Everything(string type)
        {
            Key key = Key.Create(type);
            return _fhirService.Everything(key);
        }
        ...
        public ActionResult<FhirResponse> Document(string id)
        {
